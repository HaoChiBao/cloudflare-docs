...
<Steps>
	...
	3. **Configure Cloudflare MCP servers**
		...
		Add the Cloudflare API MCP server to `~/.codeium/windsurf/mcp_config.json`. For more information about Code Mode, refer to [cloudflare/mcp](https://github.com/cloudflare/mcp).
...
- The Cloudflare API MCP server uses Code Mode — Cascade writes JavaScript to reach any of 2,500+ endpoints and current developer documentation in approximately 1,100 tokens.
