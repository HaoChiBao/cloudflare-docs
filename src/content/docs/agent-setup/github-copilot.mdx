...
<Tabs urlParam="view">
	<TabItem label="IDE extension" value="extension">
		<Steps>
	...
	<TabItem label="Desktop app" value="desktop">
		<Steps>
...
- The Cloudflare API MCP server uses Code Mode — Copilot writes JavaScript against a typed API to reach any of 2,500+ endpoints and current developer documentation in approximately 1,100 tokens.
