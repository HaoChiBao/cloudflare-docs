...
<Tabs urlParam="view">
	...
	<TabItem label="Claude Code Desktop" value="desktop">
		<Steps>
...
- The Cloudflare API MCP server uses Code Mode — Claude writes JavaScript against a TypeScript API to reach any of 2,500+ endpoints and current developer documentation in approximately 1,100 tokens.
