...
You can install the [Cloudflare plugin](https://github.com/cloudflare/skills), which bundles the Cloudflare MCP servers alongside contextual skills and slash commands for building on Cloudflare. For more details about installing skills and MCPs across agents, see [Agent setup](/agent-setup/)
