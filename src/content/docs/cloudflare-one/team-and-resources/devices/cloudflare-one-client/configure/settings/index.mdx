...
:::note
Microsoft has recently made changes to the IPs used by their applications (such as Microsoft Teams). In addition to entries from [IP address and URL web service](https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-ip-web-service?view=o365-worldwide), this setting additionally excludes the following CIDRs:
